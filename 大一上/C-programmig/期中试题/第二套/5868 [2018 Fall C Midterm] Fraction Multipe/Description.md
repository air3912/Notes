# [2018 Fall C Midterm] Fraction Multipe
...
# Input
The input contains (1+2N) lines.
The first is the case number $N$, which means the number of case in the following.
For each case has two lines:
